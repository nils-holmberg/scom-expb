...
```{r tab-02-07-5-3-02, echo=F}
knitr::kable(read.table("../csv/tab-02-07-5-3-02.csv", header=T, sep='\t', quot='"', stringsAsFactors=F, comment.char=""), format="pipe", digits=3, caption='Mellangruppsdesign.', booktabs=TRUE)
```
...
```{r tab-02-07-5-4-03, echo=F}
knitr::kable(read.table("../csv/tab-02-07-5-4-03.csv", header=T, sep='\t', quot='"', stringsAsFactors=F, comment.char=""), format="pipe", digits=3, caption='Inomgruppsdesign.', booktabs=TRUE)
```
