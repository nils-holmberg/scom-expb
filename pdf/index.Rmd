...
#Table {02-06-1-1}
#{02-06-1-1}
#above pattern will trigger ~/dev/bash/src/text-table.sh
knitr::kable(read.table("../csv/02-06-1-1.csv", header=T, sep='\t', quot='"', stringsAsFactors=F, comment.char=""), format="pipe", digits=3, caption='Some test table.', booktabs=TRUE)
```
