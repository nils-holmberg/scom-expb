...
```{r tab-02-07-1-1, echo=F}
#Tabell {tab-02-07-1-1}. Sample Sizes Needed to Achieve Statistical Power of .80 for Different Expected Relationship Strengths.
knitr::kable(read.table("../csv/tab-02-07-1-1.csv", header=T, sep='\t', quot='"', stringsAsFactors=F, comment.char=""), format="pipe", digits=3, caption='Antal deltagare som krävs för att uppnå statistisk kraft på 0.8 vid olika starka samband.', booktabs=TRUE)
```
