...
```{r tab-02-07-7-1-01, echo=FALSE}
knitr::kable(read.table("../csv/tab-02-07-7-1-01.csv", header=T, sep='\t', quot='"', stringsAsFactors=F, comment.char=""), format="pipe", digits=3, caption='Analys av data till tabellformat.', booktabs=TRUE)
```
