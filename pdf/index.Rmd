...
Diskutera expempel experiment med Facebook-poster enligt ett upplägg med mellangruppsdesign och upprepade villkor. Om vi kombinerar allt vi lärt oss hittills, inklusive randomisering och balansering.

```{r tab-02-07-5-5-02, echo=F}
#tab label and csv file not matching in this case..
knitr::kable(read.table("../csv/tab-02-07-5-5-02.csv", header=T, sep='\t', quot='"', stringsAsFactors=F, comment.char=""), format="pipe", digits=3, caption='Randomisering och balansering.', booktabs=TRUE)
```
