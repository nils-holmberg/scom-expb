...
#  booktabs=TRUE
#)
knitr::kable(read.table("../csv/02-06-1-1.csv", header=F, sep='\t', quot='"', stringsAsFactors=F, comment.char=""), format="pipe", digits=3, caption='some', booktabs=TRUE)
```
