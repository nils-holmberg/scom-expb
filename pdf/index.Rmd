...
knitr::kable(read.table("../csv/tab-02-07-5-6-02.csv", header=T, sep='\t', quot='"', stringsAsFactors=F, comment.char=""), format="pipe", digits=3, caption='Faktoriell design.', booktabs=TRUE)
```

I tabellen ovan visar vi vår tänkta Facebook-studie som ett 2x3 faktoriellt experiment med mellangruppsdesign. Eftersom detta ger oss totalt 6 kombinerade villkor av två faktorer, där _n_ står för antalet alternativ och _r_ står för antalet alternativ vi vill välja från
...
Diskutera expempel experiment med Facebook-poster enligt ett upplägg med faktoriell design. Detta designmönster med två experimentella villkor som "korsas" med två experimentella stimuli för varje par av deltagare kallas ibland på engelska för "crossed experimental design", och kan anses som mycket användbar inom beteendevetenskapliga studier 

3x2 faktoriell design. Tillåter att effekten av alla nivåer på varje enskild faktor testas, liksom effekten av alla kombinationer av faktorer (interaktioner). Används ofta inom naturvetenskapliga sammanhang, t.ex. materialtestning. \"Fully crossed design\" - variables and level of variables (e.g. 2x3 between-subjects design) - kan göras som mellan grupp eller inom grupp ?

### Fallstudie-experiment {#sub07.5.7}

SCED vs RCT. Single-case design, traditionell RCT (randomized controlled trial ) vs SCED (single-case experimental designs), https://www.nof1sced.org/
