...
TODO: Ta upp levels of measurement. Olika datanivåer. Nominal, Kvot-skala. Intervall. Nominal tillåter bara analyser som handlar om att räkna antal förekomster. Ta upp psychopy3 2020 som exempel.

```{r tab-02-07-3-1-01, echo=F}
knitr::kable(read.table("../csv/tab-02-07-3-1-01.csv", header=T, sep='\t', quot='"', stringsAsFactors=F, comment.char=""), format="pipe", digits=3, caption='Mätnivåer och information.', booktabs=TRUE)
```
