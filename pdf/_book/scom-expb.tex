...
\toprule
kontroll & behandling & t.värde & p.värde & frihetsgrader\tabularnewline
\midrule
\endfirsthead
\toprule
kontroll & behandling & t.värde & p.värde & frihetsgrader\tabularnewline
...
\caption{Typ I och typ II fel.}\label{fig:fig-02-08-2-1}
\end{figure}
