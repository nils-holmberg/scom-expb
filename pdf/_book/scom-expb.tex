...
\subsection{Deskriptiv statistik}\label{sub08.2.1}}
...
\subsection{Inferentiell statistik}\label{sub08.2.2}}
...
\subsection{Presentation av statistik}\label{sub08.2.3}}

Här kommer något om diagram och visualiseringar.

\hypertarget{sec08.3}{%
\section{Diskussion}\label{sec08.3}}
...
\subsection{Hypoteser och empiriska resultat}\label{sub08.3.1}}
...
\subsection{Alternativa förklaringar till resultat}\label{sub08.3.2}}

Lägg noga märke till var skiljetecken satts ut, var det ska vara kursiv stil etc. Vid engelska titlar ändras \emph{and} till \emph{och} eller \emph{\&, in} til

\hypertarget{sub08.3.3}{%
\subsection{Framtida forskning}\label{sub08.3.3}}

Hkommer lite Brödtext igen. Här kommer lite Brödtext igen. Här kommer lite Brödtext igen.

\hypertarget{sec08.4}{%
\section{Publicering}\label{sec08.4}}
