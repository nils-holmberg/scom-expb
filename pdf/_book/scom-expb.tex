...
\begin{itemize}
\item
  effektstorlek!!!! Effektstorleken kan uttryckas som skillnaden mellan medelvärdet för båda grupper, dvs 1 sekund visuell uppmärksamhet. Hänvisa tillbaka till power analys (avsnitt \protect\hyperlink{sub07.1.1}{7.1.1} förstudier)
\item
