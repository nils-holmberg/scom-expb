...
Rapportering - exempel på hur detta skulle kunna formuleras i ett manuskript\ldots{}
...
\subsection{Planering av dataanalys}\label{sub07.7.2}}

Hur lång tid kan man låta ett experiment ta.

\hypertarget{sub07.7.3}{%
\subsection{Rapportering av dataanalys}\label{sub07.7.3}}
