...
\caption{\label{tab:tab-02-07-3-1-01}Mätnivåer och information.}\tabularnewline
\toprule
SCALE. & NOMINAL. & ORDINAL. & INTERVAL. & RATIO.\tabularnewline
\midrule
\endfirsthead
\toprule
SCALE. & NOMINAL. & ORDINAL. & INTERVAL. & RATIO.\tabularnewline
\midrule
\endhead
Names or Categories & X & X & X & X\tabularnewline
Order or Rankings & & X & X & X\tabularnewline
Measurements with arbitrary zero & & & X & X\tabularnewline
Proportional measurements with absolute zero & & & & X\tabularnewline
\bottomrule
\end{longtable}
