...
\begin{longtable}[]{@{}llll@{}}
\caption{\label{tab:tab-02-07-5-6-02}Faktoriell design.}\tabularnewline
\toprule
Försök\_Deltagare. & Deltagare\_1. & Deltagare\_2. & Deltagare\_3\tabularnewline
\midrule
\endfirsthead
...
I tabellen ovan visar vi vår tänkta Facebook-studie som ett 2x3 faktoriellt experiment med mellangruppsdesign. Eftersom detta ger oss totalt 6 kombinerade villkor av två faktorer, där \emph{n} står för antalet alternativ och \emph{r} står för antalet alternativ vi vill välja från
...
SCED vs RCT. Single-case design, traditionell RCT (randomized controlled trial ) vs SCED (single-case experimental designs), \url{https://www.nof1sced.org/}
