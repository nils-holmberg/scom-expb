...
Introduktion. I denna del av en artikel behandlas tidigare forskning och hur hypoteserna för vår egen studie har härletts från tidigare resultat inom samma ämne.\strut
\end{minipage} & \begin{minipage}[t]{0.07\columnwidth}\raggedright
Kapitel 6 (s NN)\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.05\columnwidth}\raggedright
M\strut
\end{minipage} & \begin{minipage}[t]{0.80\columnwidth}\raggedright
Metod. I denna del behandlas experimentets utformning. Denna del måste vara tillräckligt detaljerad för att andra forskare inom samma ämne ska kunna upprepa (replikera) vår egen studie.\strut
\end{minipage} & \begin{minipage}[t]{0.07\columnwidth}\raggedright
Kapitel 7 (s NN)\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.05\columnwidth}\raggedright
R\strut
\end{minipage} & \begin{minipage}[t]{0.80\columnwidth}\raggedright
Resultat. Denna del rapporterar kortfattat de faktiska resultaten av vårt experiment, och relaterar dessa till de förväntade resultat som uttrycktes i studiens hypoteser.\strut
\end{minipage} & \begin{minipage}[t]{0.07\columnwidth}\raggedright
Kapitel 8 (s NN)\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.05\columnwidth}\raggedright
D\strut
\end{minipage} & \begin{minipage}[t]{0.80\columnwidth}\raggedright
Diskussion. Denna del diskuterar relevansen av experimentets resultat i ett större samhälleligt perspektiv, samt eventuella alternativa förklaringar till studiens resultat. Undersökningens begränsningar.\strut
\end{minipage} & \begin{minipage}[t]{0.07\columnwidth}\raggedright
Kapitel 9 (s NN)\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
