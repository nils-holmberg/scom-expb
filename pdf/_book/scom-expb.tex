...
Hypoteser och empiriska resultat. Vi säger inte att hypoteser bekräftats eller besannats, utan vi säger om resultaten ger stöd eller inte till hypoteserna. Relatera faktiska observationer till ursprungliga förväntade hypoteser. \textbf{Kan resultaten generaliseras? Validitet och reliabilitet}
